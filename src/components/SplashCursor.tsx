...
const SplashCursor: React.FC<SplashCursorProps> = ({
  ...
  useEffect(() => {
    ...
    const pointers = [new PointerClass()];
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      if (!gl) {
        return { gl: null, ext: { formatRGBA: null, formatRG: null, formatR: null, halfFloatTexType: 0, supportLinearFiltering: null } };
      }
    ...
    function generateColor() {
      ...
      // Restrict hue to blue shades (0.55 to 0.68)
    ...
    // touchmove listener needs { passive: false } or standard passive mode checking, preventDefault is not explicitly used here but let's handle passive config if needed
